...
echo "\n jugadores"
curl -X POST -H "Content-Type: application/json" \
  --data '{"nombre": "Juan Perez", "id_jugador": 1, "posicion": "Delantero", "fecha_nacimiento": "1995-01-01T00:00:00Z", "altura": "1.80", "pais_nombre": "Argentina"}' \
  "$BASE_URL/jugadores"
...
curl -X PUT -H "Content-Type: application/json" \
  --data '{"nombre": "Juan Perez", "id_jugador": 1, "posicion": "Mediocampista", "fecha_nacimiento": "1995-01-01T00:00:00Z", "altura": "1.80", "pais_nombre": "Argentina"}' \
