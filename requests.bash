...
paises=(
  ...
  "Tailandia" "Taiwán" "Tanzania" "Tayikistán" "Timor Oriental" "Togo" "Tonga" 
...
curl -X POST -d "agregarNombre=Juan Portillo&agregarPosicion=Defensor&agregarPais=Argentina&agregarNumero=5&agregarAltura=182&agregarFechaNacimiento=2000-05-18" "$BASE_URL/jugadores"
